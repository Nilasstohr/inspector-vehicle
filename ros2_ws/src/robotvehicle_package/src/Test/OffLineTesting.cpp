...
void OffLineTesting::LoadRecords(){
...
void OffLineTesting::getValuesFromLine(string line, float &val1, float &val2){
...
float OffLineTesting::getValueFromString(string s){
...
GridMap *OffLineTesting::getGripMap() {
    return gripMap;
}

bool OffLineTesting::hasRecordsToProcess() {
    return !recording->empty();
}

KalmanLocalization *OffLineTesting::getLocalization() {
    return localization;
}
